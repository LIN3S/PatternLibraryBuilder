...
(0, _lin3sEventBus.onDomReady)(initAccordions);
...
var initClipboard = function initClipboard() {
  new _clipboard2.default('.js-clipboard');
};

(0, _lin3sEventBus.onDomReady)(initClipboard);
...
var _Tabbed = __webpack_require__(12);

var _Tabbed2 = _interopRequireDefault(_Tabbed);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var initTabbeds = function initTabbeds() {
...
(0, _lin3sEventBus.onDomReady)(initTabbeds);
...
var initFinders = function initFinders() {
  var finders = document.querySelectorAll('.js-finder');
...
(0, _lin3sEventBus.onDomReady)(initFinders);
...
var Accordion = function () {
  function Accordion(domNode, _ref) {
    var _this = this;

    var itemSelector = _ref.itemSelector,
        itemOpenedClass = _ref.itemOpenedClass,
        itemHeaderClassSelector = _ref.itemHeaderClassSelector;

    _classCallCheck(this, Accordion);

    this.items = [];

    var $accordionItems = (0, _jquery2.default)(domNode).find('.' + itemSelector).first().parent().children('.' + itemSelector);

    Array.from($accordionItems).forEach(function (accordionItemNode) {
      return _this.items.push(new _AccordionItem2.default(accordionItemNode, {
        itemOpenedClass: itemOpenedClass,
        itemHeaderClassSelector: itemHeaderClassSelector,
        onItemClickCallback: _this.onAccordionItemSelected.bind(_this),
        isInitiallyCollapsed: !(0, _jquery2.default)(accordionItemNode).hasClass(itemOpenedClass)
      }));
    });
  }

  _createClass(Accordion, [{
    key: 'onAccordionItemSelected',
    value: function onAccordionItemSelected(anAccordionItem) {
      this.items.forEach(function (accordionItem) {
...
var AccordionItem = function () {
  function AccordionItem(domNode, _ref) {
    var itemOpenedClass = _ref.itemOpenedClass,
        itemHeaderClassSelector = _ref.itemHeaderClassSelector,
        _ref$onItemClickCallb = _ref.onItemClickCallback,
        onItemClickCallback = _ref$onItemClickCallb === undefined ? function () {} : _ref$onItemClickCallb,
        _ref$isInitiallyColla = _ref.isInitiallyCollapsed,
        isInitiallyCollapsed = _ref$isInitiallyColla === undefined ? true : _ref$isInitiallyColla;

    _classCallCheck(this, AccordionItem);

    this.$item = (0, _jquery2.default)(domNode);
    this.$itemHeader = (0, _jquery2.default)(domNode).children('.' + itemHeaderClassSelector);
  ...
  _createClass(AccordionItem, [{
    ...
    value: function bindListeners() {
      ...
      this.$itemHeader.on('click', function () {
        _this.onItemClickCallback(_this);
      });
...
var Tabbed = function () {
  ...
  _createClass(Tabbed, [{
    ...
    value: function bindListeners() {
      ...
      Array.from(this.$navItems).forEach(function (navItem, index) {
        (0, _jquery2.default)(navItem).on('click', function (event) {
          event.stopPropagation();
          event.preventDefault();
    ...
    key: 'onTabSelected',
    value: function onTabSelected(tabIndex) {
      var activeNavItemClass = this.tabNavItemSelector + '--active',
...
var Finder = function () {
  function Finder(domNode) {
    var _this = this;

    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        inputClassName = _ref.inputClassName,
        subjectClassName = _ref.subjectClassName,
        invalidSubjectClassName = _ref.invalidSubjectClassName;

    _classCallCheck(this, Finder);

    var $domNode = (0, _jquery2.default)(domNode);
    ...
    this.cachedSubjectsFilterValues = Array.from(this.$subjects).map(function (subject) {
      return (0, _jquery2.default)(subject).data('finder').toLowerCase();
    });
  ...
  _createClass(Finder, [{
    ...
    key: 'filter',
    value: function filter(stringToFilter) {
      var _this2 = this;

      var stringToFilterWords = stringToFilter.toLowerCase().split(' ');
      Array.from(this.$subjects).forEach(function (subject, index) {
        var subjectFilterValue = _this2.cachedSubjectsFilterValues[index],
            isSubjectValid = stringToFilterWords.every(function (word) {
          return subjectFilterValue.includes(word);
        });
        (0, _jquery2.default)(subject).toggleClass(_this2.invalidSubjectClassName, !isSubjectValid);
      });
    }
  }]);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(14), __webpack_require__(22), __webpack_require__(19)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
